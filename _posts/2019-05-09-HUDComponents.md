...
![Common Healthbars](/img/HUD_Healthbars.png)
...
{: style="text-align:center"}
![Healthbar States](/img/HUD_Health_Loss.gif)

{: style="text-align:center"}
![Healthbar States](/img/HUD_Health_Gain.gif)

{: style="text-align:center"}
![Healthbar States](/img/HUD_Low_Health.gif)
...
{: style="text-align:center"}
![Component_Legend](/img/HUD_Component_Legend.png)

![HUD Health genre placement](/img/Health_HUD_Genres.gif)
...
![HUD Score genre placement](/img/Score_HUD_Genres.gif)
...
![HUD Timers genre placement](/img/Timer_HUD_Genres.gif)
...
{: style="text-align:center"}
![Common Ammo Count](/img/HUD_Ammocount.png)
...
![HUD Ammo genre placement](/img/Ammo_HUD_Genres.gif)
...
{: style="text-align:center"}
![Common Reticle States](/img/HUD_Reticle_States.png)
...
![HUD Reticle genre placement](/img/Reticle_HUD_Genres.gif)
...
![HUD Compass genre placement](/img/Compass_HUD_Genres.gif)
...
![HUD Minimap genre placement](/img/Minimap_HUD_Genres.gif)
